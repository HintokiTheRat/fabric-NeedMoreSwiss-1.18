...
public class NeedMoreSwissBlocks {
    ...
    public static final Block COLORATA_LOG = registerBlock("colorata_log",
            new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block STRIPPED_COLORATA_LOG = registerBlock("stripped_colorata_log",
            new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_OAK_LOG).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_WOOD = registerBlock("colorata_wood",
            new PillarBlock(FabricBlockSettings.copy(Blocks.OAK_WOOD).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block STRIPPED_COLORATA_WOOD = registerBlock("stripped_colorata_wood",
            new PillarBlock(FabricBlockSettings.copy(Blocks.STRIPPED_OAK_WOOD).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);


    public static final Block COLORATA_PLANKS = registerBlock("colorata_planks",
            new Block(FabricBlockSettings.copy(Blocks.OAK_PLANKS).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);



    public static final Block COLORATA_BUTTON = registerBlock("colorata_button",
            new NeedMoreSwissWoodenButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON).strength(2f).requiresTool().noCollision()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);
    ...
    public static final Block COLORATA_PRESSURE_PLATE = registerBlock("colorata_pressure_plate",
            new NeedMoreSwissPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE)
                    .strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_FENCE = registerBlock("colorata_fence",
            new FenceBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_FENCE_GATE = registerBlock("colorata_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copy(Blocks.OAK_FENCE_GATE).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_LOGS_WALL = registerBlock("colorata_logs_wall",
            new WallBlock(FabricBlockSettings.of(Material.WOOD).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_SLAB = registerBlock("colorata_slab",
            new SlabBlock(FabricBlockSettings.copy(Blocks.OAK_SLAB).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);
    ...
    public static final Block COLORATA_STAIRS = registerBlock("colorata_stairs", new NeedMoreSwissStairsBlock(NeedMoreSwissBlocks.COLORATA_PLANKS
            .getDefaultState(), FabricBlockSettings.copy(Blocks.OAK_STAIRS).strength(2f).requiresTool()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);


    public static final Block COLORATA_DOOR = registerBlock("colorata_door", new NeedMoreSwissDoorBlock(
            FabricBlockSettings.copy(Blocks.OAK_DOOR).strength(2f).requiresTool().nonOpaque()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);

    public static final Block COLORATA_TRAPDOOR= registerBlock("colorata_trapdoor", new NeedMoreSwissTrapdoorBlock(
            FabricBlockSettings.copy(Blocks.OAK_TRAPDOOR).strength(2f).requiresTool().nonOpaque()), NeedMoreSwissItemGroup.CRIMERZBOOGALOO_GROUP);
